...
test('anchor', async ({ page }) => {
  ...
  await expect(testGetHref).toHaveText('https://khulnasoft.com/');
  ...
  await expect(testGetSearchHref).toHaveText('https://khulnasoft.com/?a=42&b=23');
  ...
  await expect(testSetSearchHref).toHaveText('https://khulnasoft.com/?x=1&y=2');
});
