...
See the [distribution](https://partytown.khulnasoft.com/distribution) section about the various files created. Note that both the root directory, and the `tests` directory receive a copy of the build files, such as `tests/~partytown/partytown.js`.
...
Please also see the [FAQ section](https://partytown.khulnasoft.com/faq) for more info
...
If it works, great! Send us a PR and we'd love to merge it in and highlight it as a working integration on our [Common Services page](https://partytown.khulnasoft.com/common-services) . If for any reason it does not work, we would love to help you figure out why it might not be working and figure out a way forward.
...
https://partytown.khulnasoft.com/
